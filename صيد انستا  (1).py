...
print('''\033[1;32m
    _   _   _   _     _   _   _   _   _   _  
   / \ / \ / \ / \   / \ / \ / \ / \ / \ / \\
  \033[1;37m( A | M | I | R ) ( A | L | S | Y | R | I )
  \033[1;32m \_/ \_/ \_/ \_/   \_/ \_/ \_/ \_/ \_/ \_/  
''');print(' \x1b[1;32m ادخل توكن بوتك');tok = input('[⊰⊱]\033[1;37m  TOKEN : ')
print(' \x1b[1;32m ادخل ايدي بوتك');idd =input('\033[1;32m[⊰⊱]\033[1;37m  ID : ');rd = requests.get('https://api.telegram.org/bot' + str(tok) + '/sendMessage?chat_id=' + str(idd) + '&text= ┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉\n╮❲ تم تشغيل الاداة بنجاح ❳\n┤❲ سيتم ارسال الصيد الي بوتك ❳\n┤❲ المبرمج ❳ > @A_6_60\n╯❲ قنواتي تيليجرام ❳ ⇣\nBY❲ @A_8_A_0 ❳ 💬 ❲ @PYY60 ❳\n┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉').text;import webbrowser
...
{green}───────────────────────────────────────────
{orange}كـل الحـب وتقـدير يتمنـاها لكـم ( امير ااسوري )
{green}───────────────────────────────────────────
{magenta}اداة صيد متاحات انستجرام 
{green}───────────────────────────────────────────
